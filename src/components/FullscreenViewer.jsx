...
function FullscreenViewer({ 
  ...
  return (
    <div 
      ref={modalRef}
      className="fixed inset-0 z-500 flex items-center justify-center modal-container"  //modal-container
      style={{/*
        position: 'fixed',
        top: 0,
        left: 0,
    ...
    >
      ...
      <div 
        ref={modalContentRef} 
        className="grid grid-cols-1 md:grid-cols-2 h-full w-[100vw] p-4 md:p-12 gap-6"
        style={{ opacity: 0 }}
      >
        {/* Left Column - Image */}
        ...
        <div className="flex flex-col h-full justify-end overflow-y-auto px-4 py-8 md:py-16">
          {currentProject && (
            <>
              {/* Project Title */}
